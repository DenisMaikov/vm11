class UniversalCalculator extends RealCalculator {
    ...
    one(type, elem) {
        ...
        switch(type) {
            ...
            case 'Matrix': return new VectorCalculator.one(elem.values.length, elem.values[0][0]);
    ...
    zero(type, elem) {
        ...
        switch(type) {
            ...
            case 'Matrix': return (new VectorCalculator).zero(elem.values.length, elem.values[0][0]);
